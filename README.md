# Test Login Register App

Aplikasi ini dibangun dengan teknologi dan pustaka berikut:
...
- **Redux**: Untuk manajemen state global yang memudahkan pengelolaan data dan alur logika di seluruh aplikasi.
- **lottiefiles**: Untuk menambahkan animasi Lottie yang interaktif dan ringan.
- **Formik & Yup**: Untuk manajemen form yang efisien dan validasi input pengguna secara mudah dan konsisten.
...
1. **Clone Repository**
   ...
   ```bash
   git clone https://github.com/TeguhA10/frontendKalebMakmur.git
